...
def main():
    annot_path = 'surface/shaefer-400-7.annot.json'
    annot = json.load(open(annot_path, 'r'))
    brain_region_names = extract_brain_region_names(annot)
    brain_region_names.remove('Background+FreeSurfer_Defined_Medial_Wall')
    save_path = 'shaefer-400-7_region_names.txt'
